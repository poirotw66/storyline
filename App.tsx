...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const savedTheme = localStorage.getItem('storyboard_pro_theme') as 'dark' | 'dusk';
    if (savedTheme && (savedTheme === 'dark' || savedTheme === 'dusk')) {
  ...
  useEffect(() => {
    ...
    localStorage.setItem('storyboard_pro_theme', state.theme);
  }, [state.theme]);
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col font-sans relative transition-colors duration-300">
      <Header theme={state.theme} setTheme={(theme) => setState(prev => ({ ...prev, theme }))} />
        ...
        {(state.step === 'visualizing' || state.step === 'complete') && state.analysis && (
          <div className="space-y-10 animate-fade-in-up">
            ...
            <div className="hidden print:block mb-8">
               ...
               <p className="text-gray-600">Generated by 十頁分鏡</p>
            </div>
